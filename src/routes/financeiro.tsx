...
export const Route = createFileRoute("/financeiro")({
  head: () => ({
    meta: [
      { title: "Financeiro — Produtividade R3" },
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Custo, faturamento e margem acumulados no período</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-5">
            ...
            <p className="mt-4 text-xs uppercase tracking-wider text-muted-foreground">Faturamento Total</p>
            <p className="mt-1 font-display text-3xl font-semibold text-foreground">{fmt(totals.totalFatura)}</p>
          </CardContent>
        </Card>
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-5">
            ...
            <p className="mt-4 text-xs uppercase tracking-wider text-muted-foreground">Custo Total</p>
            <p className="mt-1 font-display text-3xl font-semibold text-foreground">{fmt(totals.totalCusto)}</p>
          </CardContent>
        </Card>
        <Card className="border-border/60 shadow-sm">
          <CardContent className="p-5">
            ...
            <p className="mt-4 text-xs uppercase tracking-wider text-muted-foreground">Margem</p>
            <p className="mt-1 font-display text-3xl font-semibold text-foreground">{fmt(totals.margem)}</p>
            <p className="mt-1 text-xs text-muted-foreground">{margemPct.toFixed(1)}% do faturamento</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader>
          ...
          <p className="mt-1 text-xs text-muted-foreground">Custo, faturamento e margem por mês</p>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={320}>
            <AreaChart data={monthlyData} margin={{ left: -10, right: 8, top: 8 }}>
              <defs>
                ...
                <linearGradient id="gCustoF" x1="0" y1="0" x2="0" y2="1">
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader>
          <CardTitle className="text-base">Margem por Loja</CardTitle>
          <p className="mt-1 text-xs text-muted-foreground">% de margem sobre o faturamento de cada loja</p>
        </CardHeader>
